...
function paintSelectSuggestedColor(e) {
...
function getGrayscaleCanvas() {
    ...
    ctx.drawImage(paintCanvas, 0, 0, 28, 28);
...
async function updateDoodleColors() {
    ...
    try {
        ...
        const results = await classifier.classify(paintCanvas);
...
function startDoodleSuggestions() {
