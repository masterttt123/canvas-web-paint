import { normalizeHex, registerFeedback } from './pallete.js';
...
export function getPaintInitialDataUrl() {
    return paintInitialDataUrl;
}

export function getPaintDataUrl() {
    return paintGetDataUrl();
}

export function getPaintCurrentColor() {
    return paintCurrentColor;
}

export function setPaintCurrentColor(color) {
    paintCurrentColor = color;
}

export function getPaintCurrentTool() {
    return paintCurrentTool;
}

export function getPaintCtx() {
    return paintCtx;
}

export function getPaintBackground() {
...
function paintSelectColor() {
    const pickedColor = normalizeHex(this.dataset.color);
    if (!pickedColor) return;

    paintCurrentColor = pickedColor;
    ...
    registerFeedback(pickedColor, 'default');
}

function paintPickColor() {
    const pickedColor = normalizeHex(this.value);
    if (!pickedColor || paintCurrentColor === pickedColor) return;
